        ...
        <form action="">
            <div class="filter__wrapper">
                ...
                <div class="filter__range">
                    ...
                    <div><label for="praceFrom">От:</label><input type="text" id='praceFrom' name="praceFrom"></div>
                    <div><label for="praceTo">До:</label><input type="text" id='praceTo' name="praceTo"></div>
                </div>
                <div class="filter__stock">
                    ...
                    <div><input type="text" id='count' name="count"><label for="count">Штук</label></div>
                </div>
