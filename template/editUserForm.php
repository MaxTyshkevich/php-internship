...
<form action="" method="post" enctype="multipart/form-data">
    <div class="form">
        ...
        <span>Фамилия <input type="text" name="edit_text_surname" required="" value="<?= $user['surname'] ?>"> </span>
        <span>Город
                        <select size="1" name="edit_selsity">
                            <?php foreach ($resultAllCity as $city) {
	                            $SelectedOption = $city['id'] === $user['city_id'] ? 'selected' : null;
	                            ?>
